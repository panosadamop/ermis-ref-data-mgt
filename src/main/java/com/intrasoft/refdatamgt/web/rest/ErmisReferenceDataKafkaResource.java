...
@RestController
@RequestMapping("/api/ermis-reference-data-kafka")
public class ErmisReferenceDataKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ErmisReferenceDataKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ErmisReferenceDataKafkaResource(KafkaProperties kafkaProperties) {
